...
echo Aguardando 15 segundos para o Login Server inicializar...
timeout /t 15 /nobreak

echo Iniciando Game Server...
start "AION - Game Server" "%~dp0start_game.bat"

echo Aguardando 45 segundos para o Game Server inicializar...
echo (Game Server leva mais tempo devido ao carregamento de dados)
