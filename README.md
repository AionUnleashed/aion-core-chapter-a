# AION Core 4.7.5 - Java 8 Migration ✅

> **Status**: Migração para Java 8 concluída com sucesso! Servidor rodando estável em JDK 8u471.
...
```powershell
# Build tudo com Maven
.\scripts\build\Builder.bat

# Ou build apenas AC-Commons
...
```
├── scripts/
│   ├── build/          # Scripts de compilação (Builder.bat, Maven, etc)
│   ├── setup/          # Scripts de instalação/configuração
│   ├── start/          # Scripts de inicialização dos servidores
│   └── maintenance/    # Scripts de manutenção/correção
├── logs/
│   └── build/          # Logs de compilação
├── docs/               # Documentação completa
│   └── JAVA8_MIGRATION_COMPLETE.md  # Relatório de migração Java 8
└── AC-*                # Módulos do projeto (Commons, Game, Login, Chat)
```

## 📚 Documentação

- **[Migração Java 8](docs/JAVA8_MIGRATION_COMPLETE.md)** - Relatório completo da migração
- **[Guia de Instalação](docs/getting_started.md)** - Setup inicial
- **[Navegação](docs/navigation.md)** - Estrutura do projeto
...
**Note**: I implemented Full **Commercial Licensing System (Client/Server)** for Aion-Core Community for protecting my works but **NOW I REMOVED IT** and **_This is my Full Source with all features v4.7.5.x (NO LICENSE SYSTEM)_**
